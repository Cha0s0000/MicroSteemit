// pages/commentsHistory/commentsHistory.js
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      complete: function (res) {
        var authorPosts = [];
        wx.request({
          url: 'https://api.steemjs.com/get_discussions_by_comments?query={"start_author":"'+author+'","start_permlink":"","limit":"10"}',
          method: 'GET',
          success: function (res) {
  ...
  onReachBottom: function (e) {
    ...
    wx.request({
      url: 'https://api.steemjs.com/get_discussions_by_comments?query={"start_author":"' + last_author + '","start_permlink":"' + last_permlink+'","limit":"10"}',
      method: 'GET',
      success: function (res) {
        console.log(res.data)
        var data = res.data;
  ...
  click: function (e) {
    var parent_author = e.currentTarget.dataset.block.parent_author;
    var parent_permlink = e.currentTarget.dataset.block.parent_permlink;
    var author = e.currentTarget.dataset.block.author;
    var permlink = e.currentTarget.dataset.block.permlink;
    console.log("click");
    console.log(author);
    wx.navigateTo({
      url: '../childComment/childComment?author=' + author + '&permlink=' + permlink + '&parent_author=' + parent_author + '&parent_permlink=' + parent_permlink,
    })
